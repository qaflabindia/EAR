...
See [`docs/WHITEPAPER.md`](docs/WHITEPAPER.md) (or its English-only
terminology edition, [`docs/WHITEPAPER_ENGLISH.md`](docs/WHITEPAPER_ENGLISH.md))
for a scholarly treatment of the architecture and a regulated-domain
case study (`examples/credit_risk_guru_ksetra.ipynb`).
